...
describe('feature module imports', () => {
  it('exposes editor module host and migrated feature screens from feature folders', async () => {
    ...
    const userActivity = await import('../../../src/features/activity/UserActivity.jsx');
    const documentHistory = await import('../../../src/features/history/DocumentHistory.jsx');
    const xmlFailure = await import('../../../src/features/reports/XmlFailure.jsx');
